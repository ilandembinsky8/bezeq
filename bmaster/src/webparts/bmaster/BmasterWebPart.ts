...
import Bmaster from './components/Bmaster';
import { IBmasterProps } from './components/IBmasterProps';
...
export default class BmasterWebPart extends BaseClientSideWebPart<IBmasterWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IBmasterProps> = React.createElement(
      Bmaster,
      {
          ...
          groups: [
            {
              ...
              groupFields: [
                ...
                PropertyPaneTextField('PageType', {
                  label: strings.PageTypeFieldLabel
                }),
